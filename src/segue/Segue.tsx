...
import { $waiter } from 'segue/symbol/Segue'
...
import { setDismissGestureState } from 'segue/private/Segue'
import { Emitter } from 'event/Emitter'
import { State } from 'gesture/GestureDetector'
import { Screen } from 'screen/Screen'
import { Waiter } from 'segue/private/Waiter'
...
export class Segue extends Emitter {
	 ...
	 * @since 0.1.0
	 */
	public transition(animator: Function): Promise<void> {
 ...
 * @since 0.1.0
 */
export const SegueRegistry: Map<string, Constructor<Segue>> = new Map()